...
enum LoadTextures
{
	...
	load_Fire, load_Orge, load_Teleport, load_Gate, load_Key, load_Gnome, load_ThiefKey
};

enum class CollisionStatus
{
	Destroy, Good, Not_Valid, Won, Teleport, OnTeleport, Ogre
};
